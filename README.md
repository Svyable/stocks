...
GitHub Actions runs tests on pushes/PRs and runs the scanner on weekdays at 21:30 UTC. Scheduled/manual scans commit refreshed `output/latest.*` files back to `main`.
